...
Renders images and GIF animations in the terminal. See [cmd/octant/README.md](cmd/octant/README.md) for full usage and flags.
...
A real-time XY phosphor oscilloscope with Gaussian beam glow, phosphor persistence, and a CRT graticule. See [cmd/octantscope/README.md](cmd/octantscope/README.md) for full usage, flags, and keyboard controls.
